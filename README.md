...
## 🍃 Ответы на вопросы рефлексии## 💬 Ответы на вопросы
...
Я бы добавил юнит-тесты хотя бы для основных компонентов. Также было бы хорошо сделать доску канбан как в Trello, где можно было перемещать задачи между различными статусами. Ну и скорее всего добавить возможность прикреплять файлы или картинки к задачам .
